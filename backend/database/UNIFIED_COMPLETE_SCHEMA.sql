-- ============================================
-- SALEM DOMINION MINISTRIES - UNIFIED COMPLETE SCHEMA
-- All-in-one database schema with all features
-- Includes: Pastor Booking, Prayer Requests, Google Meet Integration
-- ============================================
...
DROP TABLE IF EXISTS pastor_booking_availability;
DROP TABLE IF EXISTS pastor_bookings;
...
-- ============================================
-- PASTOR BOOKING & GOOGLE MEET SYSTEM
-- ============================================

-- Pastor Availability Schedule
...
-- Pastor Bookings with Google Meet Integration
CREATE TABLE pastor_bookings (
    ...
    booking_type ENUM('counseling', 'prayer', 'guidance', 'deliverance', 'thanksgiving', 'general') DEFAULT 'counseling',
    
    -- Google Meet Integration
    google_meet_link VARCHAR(500),
    google_meet_id VARCHAR(100),
    meet_join_code VARCHAR(20),
...
CREATE TABLE prayer_requests (
    ...
    request_type ENUM('general', 'healing', 'guidance', 'protection', 'thanksgiving', 'deliverance', 'family', 'financial', 'spiritual_growth', 'other') DEFAULT 'general',
    title VARCHAR(255) NOT NULL,
    ...
    status ENUM('pending', 'praying', 'answered', 'archived') DEFAULT 'pending',
...
CREATE TABLE contact_messages (
    ...
    message TEXT NOT NULL,
    message_type ENUM('general', 'prayer', 'testimony', 'feedback', 'complaint', 'children_ministry', 'booking_inquiry', 'other') DEFAULT 'general',
...
-- Default Pastor
INSERT INTO users (first_name, last_name, email, password_hash, role, is_active, email_verified) 
VALUES ('Senior', 'Pastor', 'pastor@salemdominionministries.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'pastor', TRUE, TRUE);

-- Pastor Availability Schedule
INSERT INTO pastor_booking_availability (pastor_id, day_of_week, start_time, end_time, booking_duration_minutes, max_bookings_per_day) VALUES
(2, 'monday', '09:00:00', '12:00:00', 30, 4),
(2, 'monday', '14:00:00', '17:00:00', 30, 4),
(2, 'tuesday', '09:00:00', '12:00:00', 30, 4),
(2, 'tuesday', '14:00:00', '17:00:00', 30, 4),
(2, 'wednesday', '09:00:00', '12:00:00', 30, 4),
(2, 'thursday', '09:00:00', '12:00:00', 30, 4),
(2, 'thursday', '14:00:00', '17:00:00', 30, 4),
(2, 'friday', '09:00:00', '12:00:00', 30, 4);
...
SELECT 'SALEM DOMINION MINISTRIES DATABASE SETUP COMPLETE!' as message,
       'All tables created successfully with sample data' as details,
