<?php
// Fiery & Iconic Footer Component - Services and Contact Removed
...
<!-- Fiery Footer Component - Services and Contact Removed -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-section">
                        ...
                        <ul class="footer-links">
                            <li>
                                <a href="index_perfect_responsive.php">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="footer-section">
                        ...
                        <!-- Church Statistics -->
                        <div class="event-item" style="background: var(--ember-gradient); border-color: var(--fiery-red);">
                            <div class="event-title">
...
<!-- Fiery Footer Enhancement Script -->
<script>
