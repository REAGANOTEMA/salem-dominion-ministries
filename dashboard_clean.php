...
require_once 'production_error_handler.php';
            ...
            <div class="row mb-4">
                <div class="col-md-3">
                    <div class="stats-card">
                        <div class="stats-number"><?php echo $dashboard_data['total_users'] ?? 0; ?></div>
                        <div class="text-muted">Total Users</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-card">
                        <div class="stats-number"><?php echo $dashboard_data['total_events'] ?? 0; ?></div>
                        <div class="text-muted">Total Events</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-card">
                        <div class="stats-number"><?php echo $dashboard_data['total_donations'] ?? 0; ?></div>
                        <div class="text-muted">Total Donations</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stats-card">
                        <div class="stats-number"><?php echo $dashboard_data['total_bookings'] ?? 0; ?></div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-3">
                    <div class="quick-action-card">
                        ...
                        <a href="admin_donations_perfect.php" class="btn btn-primary">Manage Donations</a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="quick-action-card">
                        ...
                        <a href="admin_communications.php" class="btn btn-primary">Send Messages</a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="quick-action-card">
                        ...
                        <a href="admin_pastor_bookings.php" class="btn btn-primary">Manage Bookings</a>
                    </div>
                </div>
            </div>
