                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mb-8">
                    ...
                    >
                      <svg className="w-6 h-6 mr-2" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.89-.49-2.4-1.31-.73-1.22-.96-2.02-.96-3.42 0-2.76 2.24-5 5-5 .29 0 .62.03.96.09.28-.89.76-1.48 1.64-1.48 1.09 0 2 .52 2.44 1.32.67.81 1.27 1.76 1.27 2.22 0 1.31-.87 2.4-2.05 2.4-.67 0-1.18-.25-1.58-.46v1.06h-2.71c.04-.88.04-1.75.04-2.63 0-2.89 0-5.42 0-5.5 0-.14.87-.33 1.7-.58 2.48l2.57.02c.04-.63.04-1.26.04-1.89 0-2.92 0-1.43 0-2.5 1.5-2.5 1.32 0 2.22.83 2.22 2.83 0 1.18-.87 2.16-2.05 2.16-.67 0-1.18-.25-1.58-.46v1.06h-2.71c.04-.88.04-1.75.04-2.63 0-2.89 0-5.42 0-5.5 0-.14.87-.33 1.7-.58 2.48z"/>
                      </svg>
                      Download for iOS
                    </button>
                    <button 
