    ...
    Building a Christ-centered community that impacts generations spiritually, socially, and economically.
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+256753244480" className="text-primary-foreground/70 hover:text-gold">
                  +256 753 244480
                </a>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:info@salemdominionministries.org" className="text-primary-foreground/70 hover:text-gold">
                  info@salemdominionministries.org
                </a>
              </div>

              <div className="flex items-center gap-4 mt-2">
                <a href="https://www.facebook.com/SalemDominionMinistries" target="_blank" rel="noopener noreferrer" className="hover:text-gold" aria-label="Visit our Facebook page"><Facebook size={20} /></a>
                <a href="https://youtube.com/@musasizifaty" target="_blank" rel="noopener noreferrer" className="hover:text-gold" aria-label="Visit our YouTube channel"><Youtube size={20} /></a>
                <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-gold" aria-label="Visit our Instagram page"><Instagram size={20} /></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-navy-light/30 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-primary-foreground/50 text-xs">
            Designed by{" "}
            <a href="https://www.ctiauganda.com" target="_blank" rel="noopener noreferrer" className="text-gold underline">
              ctiauganda.com
            </a>{" "}
            |{" "}
            <a href="https://wa.me/256772514889" target="_blank" rel="noopener noreferrer" className="text-gold underline">
              Reagan Otema
            </a>
          </p>
        </div>
