    ...
    Building a Christ-centered community that impacts generations spiritually, socially, and economically.
        ...
        <div className="border-t border-navy-light/30 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-primary-foreground/50 text-xs">
            Designed by{" "}
            <a href={EXTERNAL_LINKS.DESIGNER} target="_blank" rel="noopener noreferrer" className="text-gold underline">
              ctiauganda.com
            </a>{" "}
            |{" "}
            <a href={EXTERNAL_LINKS.DEVELOPER_WHATSAPP} target="_blank" rel="noopener noreferrer" className="text-gold underline">
              Reagan Otema
            </a>
          </p>
        </div>
