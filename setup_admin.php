...
try {
    ...
    $check_admin->bind_param('s', 'admin@salemdominionministries.com');
    $check_admin->execute();
    ...
    if ($result->num_rows == 0) {
        ...
        $insert_admin->bind_param('ssss', 'Reagan', 'Otema', 'admin@salemdominionministries.com', $hashed_password);
        ...
        echo "<p><strong>Email:</strong> admin@salemdominionministries.com</p>";
